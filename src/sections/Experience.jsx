...
import { expCards } from "../constants"; // Assuming expCards is imported from constants
                ...
                <div className="mt-32 relative">
                    <div className="relative z-50 xl:space-y-32 space-y-10">
                        {expCards.map((card, index) => (
                            <div key={card.name} className="exp-card-wrapper">
                                <div className="xl:w-2/6">
                                    {/* Pass card and index, image will be handled inside GlowCard */}
